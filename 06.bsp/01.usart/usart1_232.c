...
static uint8 uart1DMABuffer[DMA_BUFLEN_1];
...
void Usart1_DmaConfig(void){
	...
	DMA_InitStructure.DMA_BufferSize = DMA_BUFLEN_1;
...
void Usart1_DmaSend(void){
	...
	while((bufferCount<DMA_BUFLEN_1 )&&(!QueueIsEmpty(uart1Info.TxQueue))){
